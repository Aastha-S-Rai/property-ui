...
const Dashboard = () => {
  ...
  {
    fetch(`http://127.0.0.1:5000/deleteproperty/${p_id}`, { method: 'DELETE' })
  ...
  return (
    <div className="App p-3" >
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link  text-white" variant="primary" onClick={handleShow}>
                Add property
              </a>
            </li>
      ...
      <header className="App-header">
        {properties.length > 0 && (
          <div className="card_container" style={{display: "grid",background: "#cd853f", gridTemplateColumns: "20% 20% 20% 20% 20%"}}>
